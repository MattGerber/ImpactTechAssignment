...
<div class="container">
    ...
    <form:form action="/editSaveTask" method="post" modelAttribute="task">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3" for="completed">Status</label>
                <div class="col-md-6">
                    <form:radiobutton id="completed" path="completed" value="true" label="Yes"/>
                    <form:radiobutton id="completed" path="completed" value="false" label="No"/>
                </div>
            </div>
        </div>
